    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div>
            <span className="text-xl font-extrabold tracking-tight text-blue-700 block">
              Mbokdhe Fashion
            </span>
      ...
      {/* 2. Hero Section (Putih & Biru Soft) */}
      <section className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          <div className="pt-2">
            <a
              href="#katalog"
              className="inline-block px-8 py-3.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white font-extrabold text-sm rounded-xl shadow-lg shadow-blue-600/20 transition-all text-center"
            >
              Lihat Katalog Tas
            </a>
          </div>
      ...
      {/* 3. Catalog Section */}
      <section id="katalog" className="py-16 bg-slate-50 border-y border-slate-200/80 px-4 sm:px-6 lg:px-8">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-full h-56 bg-slate-100 relative overflow-hidden flex items-center justify-center">
                      ...
                      <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-md px-2.5 py-1 rounded-md border border-slate-200 text-[10px] font-mono font-bold text-slate-700">
                        #{p.id}
                      </div>

                      <div className="absolute top-3 right-3 bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded text-[10px] font-extrabold uppercase">
                        Tersedia
                      </div>
                    </div>
      ...
      <section id="keunggulan" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-sm">
            <h3 className="text-base font-extrabold text-blue-700">Kualitas Terjamin</h3>
          ...
          <div className="p-6 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-sm">
            <h3 className="text-base font-extrabold text-blue-700">Pengiriman Cepat</h3>
            <p className="text-slate-600 text-xs leading-relaxed font-medium">
          ...
          <div className="p-6 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-sm">
            <h3 className="text-base font-extrabold text-blue-700">Pelayanan Ramah</h3>
            <p className="text-slate-600 text-xs leading-relaxed font-medium">
      ...
      {/* 5. Footer (Tanpa Tombol Portal Admin) */}
      <footer id="kontak" className="bg-slate-50 border-t border-slate-200 py-10 px-4 sm:px-6 lg:px-8 text-center space-y-2">
        <p className="text-base font-extrabold text-blue-700">Mbokdhe Fashion</p>
